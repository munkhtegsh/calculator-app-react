...
export default class Calculator extends Component {
        ...
        if (this.state.display.length < 13) {
            if (this.state.display === '0') {
                ...
                this.setState((prevState, props) => {
                    return {display: prevState.display + num}
                 });
            }
        }

        //Version 2:____________________________
        // setDisplay(num) {
    ...
    setOperator(operator) {
        if (this.state.operator === '') {
            this.setState({ 
                ...
                display: '0' //without making it '', your state won't change!!!
             });
        } else {
            //black diamond
            this.setState({ 
    ...
    calculate() {
            ...
            if (this.state.operator === '+') {
                ...
                this.setState({ display: JSON.stringify(result)});
        ...
        //version: 2________________________________________________________
    ...
    clearDisplay() {
        this.setState({display: '0', temp: 0, resetDisplay: true});
    }
